...
public class CardPlusController extends BaseController {
	...
	public void answerSheet(HttpServletResponse response, String imagefile, Integer binary_thresh,
		...
		System.out.println("imagefile......."+imagefile+"...binary_thresh....."+binary_thresh+"....blue_red_thresh...."+blue_red_thresh);
		...
		System.out.println("sourePath......."+sourcePath);
        ...
        System.out.println("list<Rect>................."+listx.toString());
		...
		for (int no = 0; no < listx.size(); no++) {
			...
			for (int an = 0; an < listy.size(); an++) {
				...
				System.out.println(recty.height+".......我只想看看这是什么....."+rectx.width);
